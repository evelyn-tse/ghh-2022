...
const AllCards = () => {
  return (
    <div>
        ...
        <MainCard image={big4} imageText={"big4"} title={"What Does The Return On Investment Look Like?"} content={"Each year your wealth will increase by the return rate. To see this in action, visit our Investing page located in the navigation bar."} />
    </div>
  );
};
